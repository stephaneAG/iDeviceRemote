...
var AppleDock = {
  codes: {
    ...
    rxSetShufMode: ["0x04,0x00,0x2f"],
    txGetRepMode: ["0x04,0x00,0x30"],
    rxGetRepMode: ["0x04,0x00,0x31"],
    txSetRepMode: ["0x04,0x00,0x32"],
    txUploadPic: ["0x04,0x00,0x33"],
    txGetMaxScreen: ["0x04,0x00,0x34"],
    rxGetMaxScreen: ["0x04,0x00,0x35"],
    txGetNumSongPl: ["0x04,0x00,0x36"],
    rxGetNumSongPl: ["0x04,0x00,0x37"],
    txJumpSongPl: [""]
  },
